# This code is taken from https://github.com/wielandbrendel/bag-of-local-features-models/blob/master/bagnets/pytorchnet.py
# The version is from 21 Aug 2019.
...
def bagnet33(pretrained=False, strides=[2, 2, 2, 1], **kwargs):
    ...
    model = BagNet(
        Bottleneck, [
            3, 4, 6, 3], strides=strides, kernel3=[
            1, 1, 1, 1], **kwargs)
    if pretrained:
